...
module.exports = class {
    ...
    async disableTwoAuth() {
        ...
        let result = await Update.passwordAndEmail(this.phone);
    ...
    async listOfMessage(req) {
        ...
        let count = await Find.getCountOfListMessage(`${this.phone}SavedMessage`);
        ...
        let listOfMessage = await FindInUser.getListOfMessage({
            ...
            order: getOrder,
            startFrom: startFrom,
            tableName: `${this.phone}SavedMessage`
        });
    ...
    async createSavedMessage() {
        ...
        Create.savedMessage(this.phone);
    ...
    async uploadFile(req, res) {
        ...
        multerFile(req, res, async () => {
            ...
            await CommonInsert.message(`${this.phone}SavedMessage`, message, {
