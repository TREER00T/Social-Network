...
module.exports = class {
    ...
    async createE2EChat(req) {
        ...
        Create.e2eContent(tokenUserId, userId);

        Json.builder(Response.HTTP_CREATED);

        let tableName = `${tokenUserId}And${userId}E2EContents`;

        await Insert.chatIdInListOfUserE2E(tokenUserId, userId, tokenUserId, tableName);
        await Insert.chatIdInListOfUserE2E(userId, tokenUserId, userId, tableName);
    ...
    async deleteForMe(req) {
        ...
        await Delete.chatInListOfE2EChat(this.from, id, this.from);
    ...
    async deleteForUs(req) {
        ...
        await Delete.chatInListOfE2EChat(this.from, id, this.from);
        await Delete.chatInListOfE2EChat(this.from, id, id);
        Json.builder(Response.HTTP_OK);
    ...
    async blockUser(req) {
        ...
        await Delete.userInUsersBlockList(this.from, id);
        Json.builder(Response.HTTP_OK);
